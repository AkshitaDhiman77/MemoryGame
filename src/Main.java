...
class Game {
    ...
    public static class View extends JPanel {
        ...
        public View(Model model) {
            ...
            triesPanel.setBackground(new Color(0x050505));
            this.add(triesPanel);
            this.add(imagePanel);
        }
    ...
    public static class MemoryButton extends JButton {
        ...
        static final Image NO_IMAGE = Utilities.loadImage("no.png");
    ...
    public static class Dialogs {
        public static void showLoseDialog(JFrame window) {
            UIManager.put("OptionPane.background", new Color(0xFDFCFD));
            UIManager.put("Panel.background", new Color(0xFCFAFA));
    ...
    public static class ButtonActionListener implements ActionListener {
        ...
        static final Image TRAP_IMAGE = Utilities.loadImage("no.png");
        ...
        public ButtonActionListener(Controller controller) {
            ...
            this.trap = new ReferencedIcon(TRAP_IMAGE, "no.png");
        }
